"""Формирование таблицы отношений методом отношений максимальных амплитуд в 
паре лучей."""
...
delta_etalon, angles, dots, delta_etalon_with_dots = radar.ratio_table_pairs(eps, fr, n_beams)
